...
class AddUserForm extends Component {
  ...
  togglePopup() {
    this.setState({ personAdded: !this.state.personAdded })
  }
        ...
        <form className={b()} onSubmit={this.addPersonToData.bind(this)} href={this.props.href}>
          ...
          <div className={b("bday")}>
            ...
            <input
              ...
              className={b("input-birthday")}
              name="bday"
              onChange={this.handleStateChangeFromEvent.bind(this, "birthday")}
              required
            />
          </div>
          ...
          <SearchPerson
            ...
            onChange={this.handleStateChange.bind(this, "children")}
            placeholder="Діти"
          />
