  ...
  render() {
    ...
    return (
      <div className={b("wrapper")}>
        <Link to={`${id}/edit`} style={this.getMargins(25)} className={b("edit-button")}>
          edit
        </Link>
        ...
        <NavLink to={id}>
          <div className={this.state.className} style={this.getMargins()}>
            ...
            <div className={b("info")}>
              <h3 className={b("name")} data-text={this.state.user.name}>
                {this.state.user.name}
              </h3>
              <h3 className={b("surname")} data-text={this.state.user.surname}>
